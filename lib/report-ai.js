...
export function bindReportAI(ui,x,canEdit,visit=false) {
  ...
  button.onclick=async()=>{
    ...
    try{
      const result=await ui.assistant.request(visit?'visit_report_fr':'report_fr',snapshot);
  ...
  for(const id of (visit?['downloadVisitPdf','saveVisitPdf']:['downloadIntPdf','saveIntPdf'])){
