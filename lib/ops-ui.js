...
export class OpsUI{
  ...
  async markBilled(id){
    ...
    const x=this.data.interventions.find(x=>x.id===id&&isIndependentIntervention(x)&&x.status==='terminee');if(!x)return;
