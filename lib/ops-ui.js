...
export class OpsUI{
  ...
  async renderVisits(){
    const root=document.getElementById('visitsPage'),rows=this.data.visits.filter(v=>!v.reportDeletedAt).sort((a,b)=>String(a.plannedStart||'9999').localeCompare(String(b.plannedStart||'9999')));
