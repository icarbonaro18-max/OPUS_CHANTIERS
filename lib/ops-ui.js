...
export class OpsUI{
  ...
  async interventionPdf(x){
    ...
    const header=()=>{
      ...
      pdf.text("RAPPORT D’INTERVENTION",W-M,18,{align:'right'});
    ...
    section('CLIENT ET INTERVENTION');
    ...
    txt(`Date d’intervention : ${x.actualStart?frDateTime(x.actualStart):(x.plannedStart?frDateTime(x.plannedStart)+' (prévue)':'Non renseignée')}`,9);
    ...
    if(approved){section('COMPTE RENDU');
