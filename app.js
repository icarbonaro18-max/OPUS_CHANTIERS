import {Graph,Journal,LocalStore,CATEGORIES,uid,norm,safeName,sha,blobData,CloudError,revisionHeads,parseRevision} from './lib/cloud.js?v=3.4.0';
...
async function activate(){
 ...
 try{
  const {OpsUI}=await import('./lib/ops-ui.js?v=3.4.0');
